...
<html lang="es">
  <head>
    ...
    <!-- Title -->
    <title>Talentos Walmart Chile | Iniciar sesión</title>
      ...
      <div class="row justify-content-center">
        <div class="col-12 col-md-5 col-xl-4 my-5">
          ...
          <div class="row align-items-center">
            <img src="<?php echo e(asset('assets/img/walmart.png')); ?>" class="avatar-img text-center container" alt="...">
          </div>
          ...
          <p class="text-muted text-center mb-5">
            Acceso plataforma de talentos Walmart.
          </p>
...
</html><?php /**PATH /home/vagrant/proyectos/talentoswalmart/resources/views/auth/login.blade.php ENDPATH**/ ?>