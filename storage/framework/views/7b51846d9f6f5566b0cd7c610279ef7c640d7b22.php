...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('logo', null, []); ?> 
            ...
            <img src="<?php echo e(asset('assets/img/walmart.png')); ?>" class="avatar-img text-center container" style="width: 300px;" alt="...">
          </div>
         <?php $__env->endSlot(); ?>

        <div class="mb-4 text-sm text-gray-600">
            <?php echo e(__('¿Olvidaste tu contraseña? No hay problema. Simplemente háganos saber su dirección de correo electrónico y le enviaremos un enlace para restablecer la contraseña que le permitirá elegir una nueva.')); ?>
...
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
                    <?php echo e(__('Enviar recuperación')); ?>
...
<?php endif; ?>
<?php /**PATH /home/vagrant/proyectos/talentoswalmart/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>